...
### Setup the Projecy
  ...
  - Dowload this template from github and open it in you favourite text editor.
  ...
  - In the root directory create a `.env` file and add the following env variables
      ...
      ```
         PORT = <Port numbe of your choice>
      ```


 - go Inside the `src` folder and then execute
     ```
            npx sequelize init
    ```
  - By executing above command you will see migration , seeders and models folder inside src 
- If u are setting up your development environment , then write the username of db and password of db and in dialects put you db name like mysql, mariadb, etc. 
